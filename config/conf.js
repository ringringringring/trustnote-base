...
/*
There are 3 ways to customize conf in modules that use trustnote core lib:
...
var conf = require('./core/config/conf.js');
...
if (typeof window === 'undefined' || !window.cordova){ // desktop
	var desktopApp = require('../common/desktopApp.js'+'');
