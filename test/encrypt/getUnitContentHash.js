...
describe('encrypt->object_hash->getUnitContentHash', () => {
    ...
    describe('getUnitContentHash(obj)', () => {
        it('Verify get unit content hash from object_hash module', () => {
            
            logger.info(`Step 1. Get base64 hash from object.`)
            const actual = objectHash.getUnitContentHash(definition)
