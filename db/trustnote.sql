...
CREATE TABLE stamps (
	stamp CHAR(44) BINARY NOT NULL PRIMARY KEY, -- sha256 in base64
	creation_date timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE grants (
	unit CHAR(44) BINARY NOT NULL,
	message_index TINYINT NOT NULL,
	grantor_address CHAR(32) NOT NULL,
	address CHAR(32) NOT NULL,
	-- name VARCHAR(44) NOT NULL,
	PRIMARY KEY (unit, message_index),
	KEY byAddress(address),
	CONSTRAINT grantsByGrantorAddress FOREIGN KEY (grantor_address) REFERENCES addresses(address),
	FOREIGN KEY (unit) REFERENCES units(unit)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE assets (
	...
	spender_granted TINYINT NOT NULL, -- must subsequently publish and update the list of trusted grantors
...
CREATE TABLE asset_grantors (
	unit CHAR(44) BINARY NOT NULL,
	message_index TINYINT NOT NULL,
	asset CHAR(44) BINARY NOT NULL, -- in the initial grantor list: same as unit
	grantor_address CHAR(32) NOT NULL,
	PRIMARY KEY (unit, message_index),
	UNIQUE KEY byAssetGrantorUnit(asset, grantor_address, unit),
	FOREIGN KEY (unit) REFERENCES units(unit),
	CONSTRAINT assetGrantorsByAsset FOREIGN KEY (asset) REFERENCES assets(unit)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE inputs (
	...
	type ENUM('transfer','coinbase','issue') NOT NULL,
...
CREATE TABLE correspondent_devices (
	...
	creation_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	my_record_pref INTEGER DEFAULT 1,
 	peer_record_pref INTEGER DEFAULT 1
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4  COLLATE=utf8mb4_unicode_ci;
